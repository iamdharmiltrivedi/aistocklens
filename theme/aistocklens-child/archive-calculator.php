...
$calculators = [
    ...
    [
        ...
        'url'   => home_url( '/fd-calculator/' ),
        'color' => '#FFF8E1',
    ],
    [
        'icon'  => '📅',
        'title' => __( 'RD Calculator', 'aistocklens-child' ),
        'desc'  => __( 'Plan your Recurring Deposit and forecast the maturity amount.', 'aistocklens-child' ),
        'url'   => home_url( '/rd-calculator/' ),
        'color' => '#F3E5F5',
    ],
    [
        'icon'  => '💵',
        'title' => __( 'Lumpsum Calculator', 'aistocklens-child' ),
        'desc'  => __( 'Estimate returns on a one-time lumpsum mutual fund investment.', 'aistocklens-child' ),
        'url'   => home_url( '/lumpsum-calculator/' ),
        'color' => '#E0F2F1',
    ],
    [
        'icon'  => '💸',
        'title' => __( 'SWP Calculator', 'aistocklens-child' ),
        'desc'  => __( 'Calculate Systematic Withdrawal Plan payouts from your mutual fund corpus.', 'aistocklens-child' ),
        'url'   => home_url( '/swp-calculator/' ),
        'color' => '#FBE9E7',
    ],
];
?>
